...
export function NewFeaturesSection() {
  return (
    <div className="space-y-0">
      ...
      <section className="py-24 bg-gradient-to-b from-transparent to-primary/[0.04] dark:to-primary/[0.02]">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              ...
              {/* Decorative glow */}
              <div className="absolute -top-8 -right-8 w-64 h-64 bg-primary/10 rounded-full blur-3xl pointer-events-none" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-b from-transparent to-primary/[0.03] dark:to-primary/[0.02]">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            {/* Left: Visual */}
            <motion.div
            ...
            >
              ...
              <div className="relative">
                <div className="rounded-2xl border border-primary/20 bg-white dark:bg-card p-8 shadow-xl">
                ...
                {/* Floating labels */}
                <div className="absolute -right-4 top-8 rounded-xl bg-primary text-primary-foreground px-4 py-2 text-sm font-medium shadow-lg">
                  Text Only
                </div>
                <div className="absolute -left-4 bottom-12 rounded-xl bg-primary/80 text-primary-foreground px-4 py-2 text-sm font-medium shadow-lg">
                  No Mascots
                </div>
                
                {/* Decorative glow */}
                <div className="absolute -bottom-8 -left-8 w-64 h-64 bg-primary/10 rounded-full blur-3xl pointer-events-none" />
              </div>
            </motion.div>
